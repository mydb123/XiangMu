    ...
    <div class="product_code_preview">
        <p class='mybreadcrumb' >
            <el-breadcrumb separator-class="el-icon-arrow-right">
                <el-breadcrumb-item :to="{ path: '/workbench/raw/rawMaterialReprints' }">原料管理</el-breadcrumb-item>
                <el-breadcrumb-item :to="{ path: '/workbench/raw/rawMaterialReprints' }">原料列表</el-breadcrumb-item>
                <el-breadcrumb-item >原料补印</el-breadcrumb-item>
            </el-breadcrumb>
        </p>
        <el-card class="box-card">
            <div class="text item" style="line-height:22px">原料名称：{{raw.materialName}}</div>
            <div class="text item" style="line-height:22px">供体姓名：{{raw.name}}</div>        
            <div class="text item" style="line-height:22px">原料编码：{{raw.code}}</div>       
            <div class="text item">
