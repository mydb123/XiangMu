<template>
  <div id="rawDetailWaste">
      <el-breadcrumb>
        <el-breadcrumb-item :to="{ path: '/workbench/raw/wasteraws'}">原料管理</el-breadcrumb-item>
    ...
    <el-form disabled>
        <div class="box" style="border:0px">
            ...
            <el-row >
                ...
                <el-col :span="8"><el-input class="w260" v-model="formData.bizRaw.code"></el-input></el-col>
            </el-row>
            </div>
        </div>
            ...
            <div class='content' v-show="show1">
                <el-form disabled>
                    <el-row>
                        ...
                        <el-col :span="8"><el-input class="w260" v-model="formData.bizDonator.code"></el-input></el-col>
                        <el-col :span="4"><p>供体姓名</p></el-col>
                        <el-col :span="8"><el-input class="w260" v-model="formData.bizDonator.name"></el-input></el-col>
                    </el-row>
                    <el-row >
                        <el-col :span="4"><p>供体性别</p></el-col>
                        <el-col :span="8"><el-input class="w260" v-model="formData.bizDonator.sex"></el-input></el-col>
                    ...
                    <el-row >
                        ...
                        <el-col :span="8"><el-input class="w260" v-model="sourceArea"></el-input></el-col>
                    ...
                    <el-row >
                        ...
                        <el-col :span="8"><el-input class="w260" v-model="formData.bizDonator.discardCount"></el-input></el-col>
                    ...
                    <el-row >
                        ...
                        <el-col :span="8"><el-input class="w260" v-model="formData.bizDonator.useCount"></el-input></el-col>
        ...
        <div class="box" >
            ...
            <div class='content' v-show="show2">
                <el-row>
                    ...
                    <el-col :span="8"><el-input class="w260" :disabled="true" v-model="formData.bizRaw.materialName"></el-input></el-col>
                </el-row>
                <el-row >
        ...
        <div class="box"  v-if="formData.bizRaw.firstCheckResult == 2">
            ...
            <div class='content' v-show="show4">
                ...
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-input  class="w260" v-model="formData.bizRaw.weight"><template slot="append">g</template></el-input>
                    </el-col>
                </el-row>
