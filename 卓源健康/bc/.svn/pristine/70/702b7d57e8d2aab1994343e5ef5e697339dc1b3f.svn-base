		...
		<el-card>
			<div class='content' >
				<el-row :gutter="10" class="mb20">
					<el-col :span="3" class="lh40" style="width: 10%;">请输入姓名</el-col>
					<el-col :span="3">
...
export default {
  data() {
	...
	methods: {
		...
		//dd
		// exportExcel(){
        //                 window.location.href = "http://192.168.3.187:8088/api-bc/workbench/bizDonator/exportExcel?access_token=" + store.getters.token ;
        //         }
	},
	created() {
