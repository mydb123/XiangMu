    ...
    <div id="preparationList">
        ...
        <el-card>
            <el-row :gutter="10" class="mb20">
                ...
                <el-col :span="7"><el-input   v-model="query.code"  placeholder="请输入制备编号"></el-input></el-col>
            ...
            <el-row>
                ...
                <el-col :span="4"><el-button   @click="addPreparation"  type="primary">新增制备</el-button></el-col>
            </el-row>
