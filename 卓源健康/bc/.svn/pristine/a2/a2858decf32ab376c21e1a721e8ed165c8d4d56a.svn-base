<template>
    ...
    <div class='approval_pending_construction_partner'>
        <StepComponent :index='index' :flag='3'></StepComponent>
        <div>
            <p class='p1'>您的项目正在立项审核中...</p>
...
export default {
    ...
    methods: {
        goList() {
            this.$router.push('/construction/partner/progress/approval').then(()=>{
                location.reload();
            });
        },
    },
...
<style lang='scss'>
.approval_pending_construction_partner{
    margin: 0px auto;
