  ...
  children: [
    ...
    //库存管理
    {
      ...
      children:[
        ...
        //留样打印
        {
          path: 'reservedPrinting',
          name: '留样打印',
          hidden: true,
          component: () => import('@/views/workbench/stockControl/reservedPrinting'),
          meta: { title: '留样打印', icon: 'form', roles: ['/workbench'] }    
        },
     ...
     //附加功能
    {
      ...
      name: '附加功能',
      hidden: false,
      redirect:'/workbench/dataCoding/CodeList',
      component: () => import('@/views/workbench/dataCoding'),
      meta: {title: '附加功能',icon: 'fa fa-cog fa-lg',roles: ['/workbench']},
      children:[
        {
          path: 'CodeList',
          name: '编码列表',
          component: () => import('@/views/workbench/dataCoding/CodeList'),
          meta: { title: '编码列表', icon: 'form', roles: ['/workbench'] }    
        },
        {
          path: 'print',
          name: '新增打印',
          hidden: true,
          component: () => import('@/views/workbench/dataCoding/print'),
          meta: { title: '新增打印', icon: 'form', roles: ['/workbench'] }    
        },
        {
          path: 'BatchPrint',
          name: '批量打印',
          hidden: true,
          component: () => import('@/views/workbench/dataCoding/BatchPrint'),
          meta: { title: '批量打印', icon: 'form', roles: ['/workbench'] }  
        },
        {
          path: 'singleBatchPrint',
          name: '补印',
          hidden: true,
          component: () => import('@/views/workbench/dataCoding/singleBatchPrint'),
          meta: { title: '补印', icon: 'form', roles: ['/workbench'] }  
        },
      ]
    },
  ]
