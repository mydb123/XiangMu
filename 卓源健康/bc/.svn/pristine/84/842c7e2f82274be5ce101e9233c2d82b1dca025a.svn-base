<template>
    <div class='result_design_partner'>
...
export default {
    ...
    methods:{
        ...
        onSubmit() {
            conditionSearch(getPageDesignPartner,pageRequest,this.pageResult,this.formInline.name,5)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPageDesignPartner,pageRequest,this.pageResult,5)
    }
}
</script>
<style lang='scss'>
.result_design_partner{
    margin: 0 auto;
    padding: 25px 25px;
}
</style>