...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function(currentPage){
            pageSearch(getPagePurchaseDept,pageRequest,this.pageResult,currentPage,this.formInline.name,4)
        },
        ...
        onSubmit(){
            conditionSearch(getPagePurchaseDept,pageRequest,this.pageResult,this.formInline.name,4)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPagePurchaseDept,pageRequest,this.pageResult,4)
    },
}
</script>
 
