<template>
  <div id='rawDetailInspection'>
    <!-- 面包屑 -->
    <el-breadcrumb>
        <el-breadcrumb-item :to="{ path: '/workbench/raw/rawInspection'}">原料管理</el-breadcrumb-item>
            ...
            <div class='content' v-show="show1">
                <el-form disabled>
                    <el-row>
                        ...
                        <el-col :span="4"><el-input class="w260" v-model="formData.bizDonator.name"></el-input></el-col>
                    </el-row>
                    <el-row >
        ...
        <div class="box" >
            ...
            <div class='content' v-show="show4">
                ...
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-input class="w260" v-model="formData.bizRaw.weight">
