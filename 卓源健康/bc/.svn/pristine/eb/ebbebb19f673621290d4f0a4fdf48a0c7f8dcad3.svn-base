<template>
    <div class='approval_design_partner'>
...
export default {
    ...
    methods:{
        ...
        onSubmit() {
            conditionSearch(getPageDesignPartner,pageRequest,this.pageResult,this.formInline.name,1)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPageDesignPartner,pageRequest,this.pageResult,1)
    }
}
</script>
<style lang='scss'>
.approval_design_partner{
    margin: 0 auto;
    padding: 25px 25px;
}
</style>