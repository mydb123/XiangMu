<template>
  <div id="wasteRaws">
      <el-breadcrumb>
          ...
          <el-breadcrumb-item >废弃原料</el-breadcrumb-item>
      </el-breadcrumb>
    <el-card>
      <el-row :gutter="20">
        <el-col :span="5"><el-input  v-model="query.name" placeholder="请输入供体姓名"  class="input-with-select"></el-input></el-col>
...
export default {
  ...
  created() {
    createdSearch(getRawList,query,pageRequest,pageResult,RAW_STATUS.DISCARD);
  }
};
</script>
