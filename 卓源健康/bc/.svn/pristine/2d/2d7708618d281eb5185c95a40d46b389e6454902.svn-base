...
<div class='month_construction_dept'>
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function(currentPage){
            pageSearch(getPageConstructionDept,pageRequest,this.pageResult,currentPage,this.formInline.name,4)
        },
        ...
        onSubmit(){
            conditionSearch(getPageConstructionDept,pageRequest,this.pageResult,this.formInline.name,4)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPageConstructionDept,pageRequest,this.pageResult,4)
    },
}
</script>
 
