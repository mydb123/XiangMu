<template>
  <div class="app">
    ...
    <el-container style='height:80%'>
        ...
        <el-footer style='background:#1c1f21;'><strong><span style="font-family: 微软雅黑, &quot;Microsoft YaHei&quot;; font-size: 20px; color: rgb(255,255,255);  line-height: 60px;">卓源健康科技有限公司</span></strong></el-footer>
    </el-container>
  </div>
</template>
