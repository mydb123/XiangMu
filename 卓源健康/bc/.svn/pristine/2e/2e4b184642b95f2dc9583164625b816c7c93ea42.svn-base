<template>
    <div class="product_code_preview">
        ...
        <el-card class="box-card" v-for="item in list" :key="item.id">
            <div class="text item" style="line-height:22px">{{item.materialName}}</div>
            <div class="text item" style="line-height:22px">供体姓名：{{item.name}}</div>        
            <div class="text item" style="line-height:22px">原料编码：{{item.code}}</div>       
            <div class="text item">
