<template>
  <div id="preparationDetailWaste">
    <el-breadcrumb>
      ...
      <el-breadcrumb-item>废弃成品详情</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card>
        ...
        <div class="box" >
          ...
          <div class='content' v-show="show1">
              <el-row>
                ...
                <el-col :span="8"><el-input  class="w260" v-model="formData.bizRaw.code" disabled></el-input></el-col>
              </el-row> 
                <el-row>
...
export default {
  ...
  methods: {
    ...
    async finishedproductList(){
        ...
        this.formData.bizProduct.mainPerson = mainPerson && mainPerson+'';
        let supportPerson = res.bizProduct.supportPerson;
        this.formData.bizProduct.supportPerson = supportPerson && supportPerson+'';
        if(res.bizBox){
