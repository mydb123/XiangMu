    ...
    <div class="product_code_preview">
        <p class='mybreadcrumb' >
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item :to="{ path: '/workbench/stockControl/reservedList' }">留样列表</el-breadcrumb-item>
                <el-breadcrumb-item >留样补印</el-breadcrumb-item>
            </el-breadcrumb>
        </p>
        <el-card class="box-card">
            <div class="text item" style="line-height:22px">{{product.name}}</div>
            <div class="text item" style="line-height:22px">制备批号：{{product.code}}</div>        
