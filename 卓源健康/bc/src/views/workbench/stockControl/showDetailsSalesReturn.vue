        ...
        <div class="box" style="border:0px">
                <div class='content'>
                    <el-row class="lh40">
                        ...
                        <el-col :span="8"><el-input disabled v-model="formData.code"></el-input></el-col>
                    </el-row>
                </div>
            </div>
            <!-- 出货信息 -->
            <div class="box" >
                ...
                <el-row>
                    ...
                    <el-col :span="8"><el-date-picker class="w260" v-model="formData.date" type="date" disabled></el-date-picker></el-col>
                    <el-col :span="4"><p>出货数量</p></el-col>
                    <el-col :span="8"><el-input class="w260" v-model="formData.count" disabled></el-input></el-col>
                </el-row> 
                <el-row>
                    <el-col :span="4"><p>客户名称</p></el-col>
                    <el-col :span="8"><el-input class="w260" v-model="formData.name" disabled></el-input></el-col>
