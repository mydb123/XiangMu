<template>
  <div>
    ...
    <el-card>
      <!-- 搜索与添加 --> 
      <el-row :gutter="20">
        <el-col :span="5"><el-input clearable :span="7"  v-model="query.code" placeholder="请输入制备编号"  class="input-with-select"></el-input></el-col>
...
export default {
  ...
  created () {
    createdSearch(getpastdueList,query,pageRequest,pageResult,PRODUCT_STATUS.EXPIRE)
  }
}
</script>
