<template>
    <div id="finishedproductList">
        ...
        <el-row class="mb20" :gutter="10">
            ...
            <el-col :span="3" class="lh40">供体姓名</el-col>
            <el-col :span="4"><el-input  v-model="query.donatorName" placeholder="请输入姓名" ></el-input></el-col>
        ...
        <el-row >
            ...
            <el-col :span="2"><el-button type="warning" @click="donorListexport">导出</el-button></el-col>
        </el-row>
            <!-- 列表数据 -->
