    ...
    <div id="rawList">
        ...
        <el-card>
            <el-row :gutter="10" class="mb20">
                ...
                <el-col :span="5"><el-input  v-model="query.name" placeholder="请输入姓名" ></el-input></el-col>
                <el-col :span="2" class="lh40">初检结果</el-col>
                <el-col :span="5">
                    <el-select clearable  v-model="query.firstCheckResult" placeholder="请选择">
                        <el-option
            ...
            <el-row :gutter="10" class="mb20">
              <el-col :span="3" class="lh40" >复检结果</el-col>
                <el-col :span="5">
                    <el-select clearable  v-model="query.recheckResult" placeholder="请选择">
                        <el-option
            ...
            <el-row>
                ...
                <el-col :span="4" ><el-button   @click="addRaw"  type="primary">新增原料</el-button></el-col>
            </el-row>
