        ...
        <el-card>
                ...
                <div class="box" >
                    ...
                    <div class='content' v-show="show1">
                        <el-row >
                            ...
                            <el-col :span="8"><el-input class="w260"  v-model="bizRaw.materialName" placeholder="请输入内容"></el-input></el-col>
                        </el-row>
                        <el-row >
            ...
            <div class="box" >
                ...
                <div class='content' v-show="show3">
                    ...
                    <el-row >
                        <el-col :span="4"><p class="fuji"><i class="ziji">*</i>复检结果</p></el-col>
                        <el-col :span="8">
                        ...
                        <el-col :span="4"><p class="fuji"><i class="ziji">*</i>质检员</p></el-col>
                        <el-col :span="8">
                    ...
                    <el-row>
                        <el-col :span="4"><p class="fuji"><i class="ziji">*</i>附件上传</p></el-col>
                        <el-col :span="8">
                            <el-upload
                                class="upload-demo"
                                action 
                        ...
                        <el-col :span="4"><p class="fuji">称重</p></el-col>
                        <el-col :span="8">
