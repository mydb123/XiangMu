        ...
        <div class="box" style="border:0px">
            <div class='content'>
                <el-row class="lh40">
                    ...
                    <el-col :span="8"><el-input  class="w260"  disabled v-model="formData.code"></el-input></el-col>
                </el-row>
            </div>
        </div>
        <!-- 出货信息 -->
          ...
          <div class='content' v-show="show1">
            <el-row>
              ...
              <el-row>
                ...
                <el-col :span="8"><el-input :title="sourceArea" class="w260" v-model="sourceArea" disabled></el-input></el-col>
              </el-row> 
              <el-row class="mb20">
