        ...
        <div class="box" >
          ...
          <div class='content' v-show="show1">
              <el-row>
                ...
                <el-col :span="6"><el-date-picker class="w260" disabled v-model="formData.bizProduct.expiryDate" type="date"></el-date-picker></el-col>
              </el-row>
              <el-form disabled> 
               <el-row>
