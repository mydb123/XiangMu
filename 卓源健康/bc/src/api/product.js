...
const product = {
    ...
    exportProductExcel(query) {
     ...
     //数据编码-数据列表
    page(pageRequest) {
      return get(`${base.sq}/workbench/bizPrintNumber/page?`+ qs.stringify(pageRequest));
    },
    
    save(formData) {
      return post(`${base.sq}/workbench/bizPrintNumber/save?`+ qs.stringify(formData));
    },
