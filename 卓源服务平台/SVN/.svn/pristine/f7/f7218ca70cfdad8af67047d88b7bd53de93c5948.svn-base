...
<div class='menu_construction_partner'>
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function(currentPage){
            pageSearch(getPageConstructionPartner,pageRequest,this.pageResult,currentPage,this.formInline.name,2)
        },
        ...
        onSubmit() {
            conditionSearch(getPageConstructionPartner,pageRequest,this.pageResult,this.formInline.name,2)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPageConstructionPartner,pageRequest,this.pageResult,2)
    },
}
</script>
 
