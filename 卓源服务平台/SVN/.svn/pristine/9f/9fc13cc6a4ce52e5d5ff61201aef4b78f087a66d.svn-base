...
<div class='month_purchase_partner'>
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function(currentPage){
            pageSearch(getPagePurchasePartner,pageRequest,this.pageResult,currentPage,this.formInline.name,4)
        },
        ...
        onSubmit() {
            conditionSearch(getPagePurchasePartner,pageRequest,this.pageResult,this.formInline.name,4)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPagePurchasePartner,pageRequest,this.pageResult,4)
    },
}
</script>
 
