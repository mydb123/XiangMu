<template>
    ...
    <div class='month_review_construction_partner'>
                    ...
                    <div class="box" v-for="(item,index) in monthFormData" v-bind:key="item.id" >
                        ...
                        <div class='content' v-show="item.flag" style='width: 91%;'>
                            <el-row>
                                ...
                                <el-col :span="19"><el-date-picker v-model="item.buildMonth" type="month" placeholder="选择日期"></el-date-picker></el-col>
                            </el-row>
                            <el-row>
...
export default {
    ...
    methods: {
        ...
        alipay(){
            api.constructionPartner.monthFeePay(this.monthId).then(response => {
...
<style lang='scss'>
.month_review_construction_partner{
    margin: 10px auto;
