<template>
    ...
    <div class='result_upload_construction_partner'>
        <StepComponent :index='index' :flag='3'></StepComponent>
        <div>
            <p class='p1'>您的项目正在编制成果...</p>
...
export default {
    ...
    methods: {
        goList() {
            this.$router.push('/construction/partner/progress/result').then(()=>{
                location.reload();
            });
        },
    },
...
<style lang='scss'>
.result_upload_construction_partner{
    margin: 0px auto;
