...
<div class='plan_construction_partner'>
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function(currentPage){
            pageSearch(getPageConstructionPartner,pageRequest,this.pageResult,currentPage,this.formInline.name,3)
        },
        ...
        onSubmit() {
            conditionSearch(getPageConstructionPartner,pageRequest,this.pageResult,this.formInline.name,3)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPageConstructionPartner,pageRequest,this.pageResult,3)
    },
}
</script>
 
