...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function(currentPage){
            pageSearch(getPagePurchaseDept,pageRequest,this.pageResult,currentPage,this.formInline.name)
        },
        ...
        onSubmit(){
            conditionSearch(getPagePurchaseDept,pageRequest,this.pageResult,this.formInline.name)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPagePurchaseDept,pageRequest,this.pageResult)
    }
}
</script>
 
