<template>
    ...
    <div class='month_upload_purchase_dept'>
            ...
            <div class="wordborder" >
                ...
                <div class='content' v-show="show1">
                    ...
                    <el-row >
                        ...
                        <el-col :span="8">
                            <el-input  v-model="formData.buyer" placeholder="请输入内容" :readonly="readonly"></el-input>
                        </el-col>
                        <el-col :span="5"><p>联系方式</p></el-col>
                        <el-col :span="6">
                            <el-input  v-model="formData.buyerPhone" placeholder="请输入内容" :readonly="readonly"></el-input>
                        </el-col>
                    </el-row>
                    <el-row >
                        ...
                        <div class="box" v-for="(item,index) in previousMonthFormData" v-bind:key="item.id" >
                            ...
                            <div class='content' v-show="item.flag" style='width: 91%;'>
                                <el-row>
                                    ...
                                    <el-col :span="19"><el-date-picker v-model="item.purchasingMonth" type="date" placeholder="选择日期" format="yyyy-MM"></el-date-picker></el-col>
                                </el-row>
                                <el-row>
                    ...
                    <div class="box">
                        ...
                        <div class='content' v-show="flag" style='width: 91%;'>
                            ...
                            <el-row>
                                <el-col :span="5"><p>本次采购清单</p></el-col>
                                <el-col :span="19">
                                    <el-upload class="upload-demo" action :http-request="uploadMonthFileMethod" list-type="text"
                                     :file-list="fileList"
                            ...
                            <el-row>
                                ...
                                <el-col :span="19">
                                    <el-form-item prop="cost">
                                        <el-input  v-model.number="monthFormData.cost" placeholder="请输入内容">
                                            <template slot="append">万元</template>
                                        </el-input>
                                    </el-form-item>     
                                </el-col>
            ...
            this.$refs[ruleForm].validate((valid) => {
                if (valid) {
                    ...
                    api.purchaseDept.saveBizPurchaseMonth(this.monthFormData).then(response => {
                        if(response==false){
                            this.$message({message: '当前月度采购尚未完成，请勿重复提交',type: 'warning'});
                        }else{
                            this.$router.push('/purchase/dept/monthReview');
                        }
                    }).catch(error => {
                        console.log(error);
                    });               
