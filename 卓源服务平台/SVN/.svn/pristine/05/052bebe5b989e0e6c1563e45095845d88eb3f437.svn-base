...
<div class='fail_purchase_partner'>
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function(currentPage){
            pageSearch(getPagePurchasePartner,pageRequest,this.pageResult,currentPage,this.formInline.name,0)
        },
        ...
        onSubmit() {
            conditionSearch(getPagePurchasePartner,pageRequest,this.pageResult,this.formInline.name,0)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPagePurchasePartner,pageRequest,this.pageResult,0)
    },
}
</script>
 
