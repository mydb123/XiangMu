...
export default {
    ...
    methods:{
        ...
        onSubmit() {
            conditionSearch(getPageDesignDept,pageRequest,this.pageResult,this.formInline.name,2)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPageDesignDept,pageRequest,this.pageResult,2)
    }
}
</script>
<style lang='scss'>
