<template>
    <div class='appraise_design_dept'>
...
export default {
    ...
    methods:{
        ...
        onSubmit() {
            conditionSearch(getPageDesignDept,pageRequest,this.pageResult,this.formInline.name,6)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPageDesignDept,pageRequest,this.pageResult,6)
    }
}
</script>
<style lang='scss'>
.appraise_design_dept{
    margin: 0 auto;
    padding: 25px 25px;
}
</style>