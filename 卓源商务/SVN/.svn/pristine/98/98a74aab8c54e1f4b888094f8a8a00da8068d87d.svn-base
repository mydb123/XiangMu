<template>
    <div class='drawing_design_partner'>
...
export default {
    ...
    methods:{
        ...
        onSubmit() {
            conditionSearch(getPageDesignPartner,pageRequest,this.pageResult,this.formInline.name,2)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPageDesignPartner,pageRequest,this.pageResult,2)
    }
}
</script>
<style lang='scss'>
.drawing_design_partner{
    margin: 0 auto;
    padding: 25px 25px;
}
</style>