...
<div class='finish_construction_partner'>
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function(currentPage){
            pageSearch(getPageConstructionPartner,pageRequest,this.pageResult,currentPage,this.formInline.name,7)
        },
        ...
        onSubmit() {
            conditionSearch(getPageConstructionPartner,pageRequest,this.pageResult,this.formInline.name,7)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPageConstructionPartner,pageRequest,this.pageResult,7)
    },
}
</script>
 
