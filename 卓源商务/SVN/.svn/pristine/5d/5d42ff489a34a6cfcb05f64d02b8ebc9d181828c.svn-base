<template>
    ...
    <div class='approval_upload_purchase_partner'>
            ...
            <div class='div2'>
                <div class='content'>
                    <el-row>
                        ...
                        <el-col :span="8" >
                            <el-input v-model="formData.leader" :readonly="readonly"></el-input>
                        </el-col>
                        ...
                        <el-col :span="6">
                            <el-date-picker
                                v-model="currentDate"
                                type="date"
                                placeholder="选择日期" :readonly="readonly" value-format="yyyy-MM-dd">
                            </el-date-picker>
                        </el-col>
                    </el-row>
                </div>
            ...
            <div class="wordborder" >
                ...
                <div class='content' v-show="show2">
                    <el-row>
                        ...
                        <el-col :span="6">
                            <el-form-item prop="acquisitionStage">
                    ...
                    <el-row >
                        ...
                        <el-col :span="8">
                            <el-form-item prop="purchasingTarget">
    ...
    data() {
        return {
            ...
            rules: {
                ...
                purchasingTarget: [
                    { required: true, message: '请输入采购目标', trigger: 'blur' }
                ],
                estimatedPurchaseTime: [
                     { required: true, message: '请选择预计采购时间', trigger: 'change' }
                ]
            },
            readonly:true,
    ...
    methods: {
        ...
        submit(ruleForm) {
            this.$refs[ruleForm].validate((valid) => {
                if (valid) {
                    api.purchasePartner.save(this.formData).then((response)=>{
                        this.$router.push('/purchase/partner/approvalPending');
                    }).catch((error)=>{
                        console.log(error);
                    });                    
                } else {
...
<style lang='scss'>
.approval_upload_purchase_partner{
    margin: 10px auto;
