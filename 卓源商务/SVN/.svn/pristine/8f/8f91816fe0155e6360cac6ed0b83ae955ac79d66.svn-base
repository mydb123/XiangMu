<template>
    <div class='detail_construction_partner'>
        <el-form disabled>
        <div class="box" >
        ...
        <div class="box" >
            ...
            <div class='content' v-show="show4">
                ...
                <el-row >
                    ...
                    <el-col :span="19">
                        <el-input  v-model="formData.bizConstruction.buildScope" type="textarea" :rows="3" placeholder="请输入内容"></el-input>
                    </el-col>
                </el-row>
                <el-row >
            ...
            <div class='content' v-show="show5">
                <div class="box" v-for="(item,index) in formData.monthList" v-bind:key="item.id" >
                    ...
                    <div class='content' v-show="item.flag" style='width: 91%;'>
                        <el-row>
                            <el-col :span="5"><p>施工月次</p></el-col>
                            <el-col :span="19"><el-date-picker v-model="item.buildMonth" type="date" placeholder="选择日期" value-format="yyyy-MM"></el-date-picker></el-col>
                        </el-row>
                        <el-row>
...
export default {
    ...
    methods: {
        ...
        loadData(){
            api.constructionPartner.findProjectDetailsById(this.formData.bizConstruction.id).then(response => {
