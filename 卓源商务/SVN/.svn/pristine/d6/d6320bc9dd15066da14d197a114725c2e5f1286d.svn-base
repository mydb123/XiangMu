...
export default {
    ...
    methods:{
        ...
        onSubmit() {
            conditionSearch(getPageDesignDept,pageRequest,this.pageResult,this.formInline.name,3)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPageDesignDept,pageRequest,this.pageResult,3)
    }
}
</script>
<style lang='scss'>
