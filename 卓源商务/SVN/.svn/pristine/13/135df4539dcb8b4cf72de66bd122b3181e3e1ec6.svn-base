...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function(currentPage){
            pageSearch(getPagePurchaseDept,pageRequest,this.pageResult,currentPage,this.formInline.name,3)
        },
        ...
        onSubmit(){
            conditionSearch(getPagePurchaseDept,pageRequest,this.pageResult,this.formInline.name,3)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPagePurchaseDept,pageRequest,this.pageResult,3)
    },
}
</script>
 
