...
export default {
    ...
    methods:{
        ...
        onSubmit() {
            conditionSearch(getPageDesignPartner,pageRequest,this.pageResult,this.formInline.name,3)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPageDesignPartner,pageRequest,this.pageResult,3)
    }
}
</script>
<style lang='scss'>
