...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function(currentPage){
            pageSearch(getPageDesignDept,pageRequest,this.pageResult,currentPage,this.formInline.name,0)
        },
        ...
        onSubmit() {
            conditionSearch(getPageDesignDept,pageRequest,this.pageResult,this.formInline.name,0)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPageDesignDept,pageRequest,this.pageResult,0)
    },
}
</script>
 
