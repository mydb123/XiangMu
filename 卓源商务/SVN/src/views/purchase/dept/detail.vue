<template>
    <div class='detail_purchase_dept'>
        <el-form disabled>
        <div class="box" >
            ...
            <div class='content' v-show="show1">
                ...
                <!-- <el-row >
                    ...
                    <el-col :span="6"><el-input  v-model="formData.bizPurchase.buyerPhone" placeholder="请输入内容"></el-input></el-col>
                </el-row> -->
                <!-- <el-row >
                    <el-col :span="5"><p>项目规模</p></el-col>
        ...
        <div class="box" >
            ...
            <div class='content' v-show="show4">
                ...
                <el-row >
                    ...
                    <el-col :span="8">
                        <el-input  v-model="formData.bizPurchase.manageCost" placeholder="请输入内容">
                            <template slot="append">万元</template>
                        </el-input>
                    </el-col>
                </el-row>
...
export default {
    ...
    methods: {
        ...
        loadData(){
            api.purchaseDept.findProjectDetailsById(this.formData.bizPurchase.id).then(response => {
