...
<div class='appraise_purchase_dept'>
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function(currentPage){
            pageSearch(getPagePurchaseDept,pageRequest,this.pageResult,currentPage,this.formInline.name,6)
        },
        ...
        onSubmit(){
            conditionSearch(getPagePurchaseDept,pageRequest,this.pageResult,this.formInline.name,6)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPagePurchaseDept,pageRequest,this.pageResult,6)
    },
}
</script>
 
