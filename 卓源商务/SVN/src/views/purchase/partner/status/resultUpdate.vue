<template>
    ...
    <div class='result_update_purchase_partner'>
...
export default {
    ...
    methods: {
        ...
        findBizPurchaseProgressByExample(){//加载项目信息和最新的意见
            api.purchasePartner.findBizPurchaseProgressByExample(this.formData.id,50).then(response => {
    ...
    mounted: function () {
        ...
        this.findBizPurchaseProgressByExample();//最新意见  
    }
}
</script>

<style lang='scss'>
.result_update_purchase_partner{
    margin: 10px auto;
