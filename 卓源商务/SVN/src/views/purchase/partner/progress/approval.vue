...
<div class='approval_purchase_partner'>
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function(currentPage){
            pageSearch(getPagePurchasePartner,pageRequest,this.pageResult,currentPage,this.formInline.name,1)
        },
        ...
        onSubmit() {
            conditionSearch(getPagePurchasePartner,pageRequest,this.pageResult,this.formInline.name,1)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPagePurchasePartner,pageRequest,this.pageResult,1)
    },
}
</script>
 
