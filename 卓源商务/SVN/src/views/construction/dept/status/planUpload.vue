<template>
    ...
    <div class='plan_upload_construction_dept'>
    ...
    data() {
        return {
            ...
            rules:{
                ...
                builderPhone: [
                    { required: true, pattern: /^1[345789]\d{9}$/, message: '请输入施工人正确的联系方式', trigger: 'blur' }
                ],
                buildScope: [
    ...
    methods: {
        ...
        submit2() {
            api.constructionDept.saveConstructionPlan(this.formData).then(response => {
                this.$router.push('/construction/dept/planReview');
            }).catch(error => {
                console.log(error);
            });
        },
