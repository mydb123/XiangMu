...
<div class='appraise_construction_dept'>
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function(currentPage){
            pageSearch(getPageConstructionDept,pageRequest,this.pageResult,currentPage,this.formInline.name,6)
        },
        ...
        onSubmit(){
            conditionSearch(getPageConstructionDept,pageRequest,this.pageResult,this.formInline.name,6)
        },
        lookDetails(id){
    ...
    created() {
        createdSearch(getPageConstructionDept,pageRequest,this.pageResult,6)
    },
}
</script>
 
