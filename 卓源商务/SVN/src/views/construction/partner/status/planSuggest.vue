<template>
    ...
    <div class='plan_suggest_construction_partner'>
        <StepComponent :index='index' :flag='3'></StepComponent>
        <div>
            <p class='p1'>您的方案修改意见已提交，待修改...</p>
...
export default {
    ...
    methods: {
        goList() {
            this.$router.push('/construction/partner/progress/plan').then(()=>{
                location.reload();
            });
        },
    },
...
<style lang='scss'>
.plan_suggest_construction_partner{
    margin: 0px auto;
